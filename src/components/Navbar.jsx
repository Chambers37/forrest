  ...
  return (
    <main className='flex flex-col items-center bg-gray-100 py-4'>
      ...
      <nav className='flex space-x-6'>
        <a href="/" className={`text-2xl font-Merriweather font-medium italic transition duration-200 ${
            pathname === '/' ? 'text-black' : 'text-green-800 hover:text-lightGreen'
          }`}>Home</a>
        <span className='text-gray-400'>|</span>
        <a href="/services" className={`text-2xl font-Merriweather font-medium italic transition duration-200 ${
            pathname === '/services' ? 'text-black' : 'text-green-800 hover:text-lightGreen'
          }`}>Our Services</a>
        <span className='text-gray-400'>|</span>
        <a href="/quote" className={`text-2xl font-Merriweather font-medium italic transition duration-200 ${
            pathname === '/quote' ? 'text-black' : 'text-green-800 hover:text-lightGreen'
          }`}>Request A Quote</a>
        <span className='text-gray-400'>|</span>
        <a href="/about" className={`text-2xl font-Merriweather font-medium italic transition duration-200 ${
