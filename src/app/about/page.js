  ...
  return (
    ...
    <div>
      ...
      <section className="fade-hidden">
        <div className="text-center bg-darkerGreen">
          <h1 className="py-8 text-4xl md:text-6xl text-lightGreen font-medium">
            About Forrest Hardscape LLC
          </h1>
          <div className="flex justify-center">
            <p className="px-4 max-w-2xl text-white md:text-lg">
              Matthew Siter is the owner of Forrest Hardscape. Born and raised in Chester County, Matt is the fourth generation of his family to be involved in the horticultural field. He has been laying bricks, digging shrubs, and planting trees since he could hold a shovel.
            </p>
          </div>
          <div className="flex justify-center">
            <p className="py-8 px-4 max-w-3xl text-white md:text-lg">
              After graduating from Downingtown West High School, Matt attended Delaware Valley College (now Delaware Valley University) in Doylestown, Pennsylvania. He graduated college with a bachelor’s degree in Ornamental Horticulture with a concentration in Landscape Contracting & Management in 2014. Throughout high school, college and afterwards, Matt gained experience working for multiple nurseries and landscape companies, where he learned to manage multiple crews and complete large scale projects. In 2019, he started his own hardscape and landscape company, Forrest Hardscape.
            </p>
          </div>
        </div>
      </section>
